        ...
        <div className="container policy-page">
          ...
          <div className="policy-block">
            ...
            <p>
              ...
              inferences drawn from this personal information, depending on how you interact with
              the Services, where you live, and as permitted or required by applicable law:
            </p>
            <p>
          ...
          <div className="policy-block">
            ...
            <p>
              ...
              provide you with the Services, including to perform our contract with you, to process
              your payments, to fulfill your orders, to remember your preferences and items you are
              interested in, to send notifications to you related to your account, to process
              purchases, returns, exchanges or other transactions, to create, maintain and
              otherwise manage your account, to arrange for shipping, to facilitate any returns and
              exchanges, to enable you to post reviews, and to create a customized shopping
              experience for you, such as recommending products related to your purchases. This may
              include using your personal information to better tailor and improve the Services.
            </p>
            <p>
              ...
              communications by email, text message or postal mail, and to show you online
              advertisements for products or services on the Services or other websites, including
              based on items you previously have purchased or added to your cart and other activity
              on the Services.
            </p>
            <p>
              Security and Fraud Prevention: We use your personal information to authenticate your
              account, to provide a secure payment and shopping experience, detect, investigate or
              take action regarding possible fraudulent, illegal, unsafe, or malicious activity,
              protect public safety, and to secure our services. If you choose to use the Services
              and register an account, you are responsible for keeping your account credentials
              safe. We highly recommend that you do not share your username, password or other
              access details with anyone else.
            </p>
            <p>
              Communicating with You: We use your personal information to provide you with customer
              support, to be responsive to you, to provide effective services to you and to maintain
              our business relationship with you.
            </p>
            <p>
              Legal Reasons: We use your personal information to comply with applicable law or
              respond to valid legal process, including requests from law enforcement or government
              agencies, to investigate or participate in civil discovery, potential or actual
              litigation, or other adversarial legal proceedings, and to enforce or investigate
          ...
          <div className="policy-block">
            ...
            <p>
              ...
              review their privacy and security policies and other terms and conditions.
            </p>
            <p>
            ...
            <p>
              ...
              its use by us or by a third party.
            </p>
            <p>
              Our inclusion of such links does not, by itself, imply any endorsement of the content
          ...
          <div className="policy-block">
            ...
            <p>
              ...
              any personal information about children under the age of majority in your
              jurisdiction.
            </p>
            <p>
              If you are the parent or guardian of a child who has provided us with their personal
              information, you may contact us using the contact details set out below to request
              that it be deleted.
            </p>
            <p>
              As of the Effective Date of this Privacy Policy, we do not have actual knowledge that
              we "share" or "sell" (as those terms are defined in applicable law) personal
          ...
          <div className="policy-block">
            ...
            <p>
              ...
              Services, comply with legal obligations, resolve disputes or enforce other applicable
          ...
          <div className="policy-block">
            ...
            <p>Right to Access / Know. You may have a right to request access to personal information that we hold about you.</p>
            ...
            <p>
              ...
              to verify your identity before we can process your requests, as permitted or required
              under applicable law.
            </p>
            <p>
              In accordance with applicable laws, you may designate an authorized agent to make
            ...
            <p>We will respond to your request in a timely manner as required under applicable law.</p>
          </div>
          ...
          <div className="policy-block">
            ...
            <p>
              Depending on where you live, you may have the right to appeal our decision by
              contacting us using the contact details set out below, or lodge your complaint with
          ...
          <div className="policy-block">
            ...
            <p>
              ...
              Commission&apos;s Standard Contractual Clauses, or any equivalent contracts issued by
              the relevant competent authority of the UK, as relevant, unless the data transfer is
              to a country that has been determined to provide an adequate level of protection.
            </p>
          </div>
          ...
          <div className="policy-block">
            ...
            <p>
              We will post the revised Privacy Policy on this website, update the "Last updated"
          ...
          <div className="policy-block">
            ...
            <p>
              ...
              if you would like to exercise any of the rights available to you, please call or email
              us at{' '}
